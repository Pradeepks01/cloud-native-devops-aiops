-- Database initialization script for ecommerce Microservices
...
('admin@ecommerce.com', '$2a$10$placeholder_hash', 'Admin', 'User', 'admin'),
('customer@ecommerce.com', '$2a$10$placeholder_hash', 'John', 'Doe', 'customer');
...
'Beautiful floor-length gown crafted from premium silk', 'Luxurious silk evening gown', 'LEG-001', 'LUXE ecommerce',
'10000000-0000-0000-0000-000000000001', 1899.00, 2299.00, 15, true),

(gen_random_uuid(), 'Cashmere Coat', 'cashmere-coat',
'Elegant wool and cashmere blend coat for winter', 'Warm luxury coat', 'COAT-001', 'LUXE ecommerce',
'10000000-0000-0000-0000-000000000004', 899.00, 1200.00, 20, true),

(gen_random_uuid(), 'Leather Handbag', 'leather-handbag',
'Premium Italian leather tote bag', 'Luxury leather tote', 'BAG-001', 'LUXE ecommerce',
'10000000-0000-0000-0000-000000000003', 599.00, 799.00, 25, true),

(gen_random_uuid(), 'Diamond Necklace', 'diamond-necklace',
'Stunning diamond pendant necklace', 'Elegant diamond jewelry', 'JWL-001', 'LUXE ecommerce',
'10000000-0000-0000-0000-000000000004', 2999.00, 3999.00, 10, true),

(gen_random_uuid(), 'Designer Heels', 'designer-heels',
'Elegant stiletto heels in premium leather', 'Luxury high heels', 'SHOES-001', 'LUXE ecommerce',
