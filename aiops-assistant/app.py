...
# --- Page Config ---
st.set_page_config(
    page_title="Logira — AIOps Assistant",
    page_icon="🔍",
    layout="wide",
...
if prompt:
    ...
    with st.chat_message("assistant"):
        with st.spinner("🔍 Logira is investigating..."):
...
with st.sidebar:
    ...
    <div style="font-family: 'JetBrains Mono', monospace; padding: 1rem 0;">
        <h3 style="color: #22d3ee; font-size: 1rem;">⚡ Logira</h3>
    ...
    try:
        get_bedrock_client().get_agent(agentId=AGENT_ID)
        st.sidebar.success("AWS Connectivity: OK")
    except Exception as e:
        st.sidebar.error(f"AWS Connectivity: FAIL")
