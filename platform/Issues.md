...
### 1. ecommerce Application Metrics Not Found

- **Problem**: Even though the metrics of the cluster and node were obtained, the ecommerce Application Metrics were not available. While running it via docker compose, it was showing the metrics properly. 
